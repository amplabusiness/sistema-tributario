...
import multiEmpresaRoutes from './multi-empresa';
...
// Rotas de documentos (inclui parsing manual)
router.use('/v1/documents', documentsRoutes);

// Rotas de multi-empresa
router.use('/multi-empresa', multiEmpresaRoutes);
